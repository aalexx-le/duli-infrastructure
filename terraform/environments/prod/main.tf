...
# Provisions HA Kubernetes cluster for production environment
...
module "kubernetes_cluster" {
  ...
  depends_on = [module.networking, digitalocean_project.production]
}
...
resource "local_file" "ansible_inventory" {
  ...
  filename = "${path.module}/../../../ansible/inventories/${var.environment}/hosts.ini"
